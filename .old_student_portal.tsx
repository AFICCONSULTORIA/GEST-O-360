...
// Mock tempor├írio removido - agora usamos do Supabase
...
export const StudentPortal = ({ onBack, previewCourseId }: { onBack: () => void, previewCourseId?: string }) => {
  ...
  const mockTeachers = [
    { id: 1, name: 'Prof. Carlos (Matem├ítica)', avatar: 'https://i.pravatar.cc/150?img=11', status: 'Online agora' },
    { id: 2, name: 'Profa. Sofia (Portugu├¬s)', avatar: 'https://i.pravatar.cc/150?img=5', status: 'Visto por ├║ltimo ├ás 14:00' }
  ];
  ...
  const finishLesson = async () => {
    if (activeLesson) {
      ...
      showToast(`Voc├¬ ganhou ${activeLesson.xp} XP e ${activeLesson.coins} Moedas!`, 'success');
    }
    setActiveView('trail-map');
  ...
  const showToast = (msg: string, type: string) => {
    // Implementa├º├úo mockada ou futura de UI de toast.
  };
    ...
    <div className="min-h-[100dvh] bg-neutral-50 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 font-sans flex flex-col md:flex-row selection:bg-emerald-500/20">
      ...
      <aside className={`fixed md:sticky self-start top-0 left-0 h-[100dvh] z-50 flex flex-col transition-all duration-300 ${isMobileMenuOpen ? 'w-72 translate-x-0' : 'w-72 -translate-x-full md:translate-x-0'}`}
        ...
        <div className="relative z-10 px-5 pt-6 pb-4">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h2 className="font-black text-sm text-neutral-900 dark:text-white leading-none">Gest├úo 360 Educa├º├úo</h2>
        ...
        <nav className="relative z-10 flex-1 px-4 py-2 space-y-1 overflow-y-auto">
          ...
          {[
            { view: 'dashboard', icon: <LayoutDashboard size={18} />, label: 'Portal do Aluno', emoji: '­ƒÅá', color: 'emerald' },
            { view: 'courses', icon: <BookOpen size={18} />, label: 'Meus Cursos', emoji: '­ƒôÜ', color: 'sky' },
            { view: 'assessments', icon: <Target size={18} />, label: 'Avalia├º├Áes', emoji: '­ƒÄ»', color: 'orange' },
            { view: 'achievements', icon: <Award size={18} />, label: 'Conquistas', emoji: '­ƒÅå', color: 'amber' },
        ...
        <div className="relative z-10 px-4 pb-5 pt-2 border-t border-neutral-200/60 dark:border-neutral-800/40 space-y-1">
          ...
          {[
            { view: 'settings', icon: <Settings size={18} />, label: 'Configura├º├Áes', emoji: 'ÔÜÖ´©Å' },
            { view: 'support', icon: <HelpCircle size={18} />, label: 'Suporte', emoji: '­ƒÆ¼' },
      ...
      <main className="flex-1 flex flex-col min-h-[100dvh] relative overflow-x-hidden">
        ...
        <header className="hidden md:flex sticky top-0 z-30 w-full px-8 py-4 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-xl justify-between items-center border-b border-neutral-200/50 dark:border-neutral-800/50 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 text-sm text-neutral-500 dark:text-neutral-400">
              <span className="font-medium">Gest├úo 360 Educa├º├úo</span>
              <span>/</span>
              <span className="font-black text-neutral-900 dark:text-white capitalize">
                {activeView === 'dashboard' ? '­ƒÅá Portal do Aluno' 
                  : activeView === 'courses' ? '­ƒôÜ Meus Cursos'
                  : activeView === 'assessments' ? '­ƒÄ» Avalia├º├Áes'
                  : activeView === 'achievements' ? '­ƒÅå Conquistas'
                  : activeView === 'settings' ? 'ÔÜÖ´©Å Configura├º├Áes'
                  : '­ƒÆ¼ Suporte'}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:flex items-center gap-2 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 text-amber-700 dark:text-amber-400 px-3 py-1.5 rounded-full">
              ...
              <span className="text-[10px] font-bold text-amber-500/70">N├¡vel {studentData.level}</span>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-1.5 bg-orange-50 dark:bg-orange-500/10 border border-orange-200 dark:border-orange-500/20 text-orange-600 dark:text-orange-400 px-3 py-1.5 rounded-full">
              ...
              <span className="text-xs font-black">{studentData.streak} dias ­ƒöÑ</span>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-1 bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-200 dark:border-yellow-500/20 text-yellow-700 dark:text-yellow-400 px-3 py-1.5 rounded-full">
              ...
              <span className="text-sm leading-none mt-[-2px]">­ƒ¬Ö</span>
            </div>
          ...
          <section className="relative overflow-hidden rounded-[32px] bg-gradient-to-r from-emerald-600 via-teal-600 to-sky-600 p-8 md:p-10 text-white shadow-xl shadow-emerald-500/20 group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
              <div className="max-w-xl">
                ...
                <p className="text-emerald-50 text-lg mb-6 opacity-90 max-w-md">Voc├¬ est├í a apenas 3 diagn├│sticos de conquistar a Ins├¡gnia de Mestre de Matem├ítica.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <section className="pt-2">
                ...
                <div className="space-y-3">
                  {[
                    {
                      id: 'test-1',
                      title: 'Diagn├│stico de Ci├¬ncias Naturais',
                      type: 'quiz' as const,
                      duration: '45 min',
                      xp: 150,
                      coins: 50,
                      questions: [
                        { id: 'q1', question: 'Qual planeta ├® conhecido como o Planeta Vermelho?', options: ['V├¬nus', 'Marte', 'J├║piter', 'Saturno'], correctAnswer: 1 },
                        { id: 'q2', question: 'Qual ├® o maior oceano da Terra?', options: ['Oceano Atl├óntico', 'Oceano ├ìndico', 'Oceano Pac├¡fico', 'Oceano ├ürtico'], correctAnswer: 2 }
                      ]
                    },
                    {
                      id: 'test-2',
                      ...
                      coins: 30,
                      questions: [
                        { id: 'q1', question: 'Qual ├® o maior pa├¡s do mundo em extens├úo territorial?', options: ['China', 'EUA', 'Canad├í', 'R├║ssia'], correctAnswer: 3 },
                        { id: 'q2', question: 'Em qual continente fica o Egito?', options: ['├üfrica', '├üsia', 'Europa', 'Am├®rica do Sul'], correctAnswer: 0 }
                      ]
                    }
                  ].map((test, index) => (
                    <div key={test.id} onClick={() => handleStartLesson(test)} className={`flex items-center justify-between p-4 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-md rounded-[20px] border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm hover:shadow-md ${index === 0 ? 'hover:border-emerald-200 dark:hover:border-emerald-800' : 'hover:border-sky-200 dark:hover:border-sky-800'} transition-all cursor-pointer group`}>
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-neutral-500 mt-0.5">Dura├º├úo: {test.duration} ÔÇó {test.questions.length} quest├Áes</p>
                        </div>
                      </div>
            ...
            <aside className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-gradient-to-br from-violet-600 to-indigo-700 p-6 rounded-[24px] shadow-lg relative overflow-hidden text-white group">
                ...
                <div className="relative z-10 flex flex-col h-full min-h-[160px] justify-between">
                  <div className="flex items-start justify-between">
                    ...
                    <span className="text-2xl">­ƒº®</span>
                  </div>
                  <div className="mt-6">
                    <h4 className="text-xl font-black leading-tight mb-2">O Mist├®rio da Equa├º├úo Perdida</h4>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="flex flex-col items-center gap-2 group cursor-pointer">
                    <div className="w-14 h-14 rounded-2xl bg-amber-50 dark:bg-amber-500/10 flex items-center justify-center border border-amber-200/50 transition-transform group-hover:scale-110 group-hover:shadow-md">
                      <span className="text-2xl">Ô¡É</span>
                    </div>
                  ...
                  <div className="flex flex-col items-center gap-2 group cursor-pointer">
                    ...
                    <span className="text-[10px] font-bold text-neutral-500 text-center uppercase tracking-wide">Rel├ómpago</span>
                  </div>
              ...
              <div className="bg-white/80 dark:bg-neutral-900/80 backdrop-blur-md p-6 rounded-[24px] border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm">
                ...
                <p className="text-xs text-neutral-500 font-medium">Gael e outros 4 est├úo estudando agora.</p>
              </div>
            ...
            <div className="w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-fuchsia-500 rounded-[32px] p-1 shadow-xl shadow-indigo-500/20 relative group overflow-hidden">
              ...
              <div className="bg-neutral-900/40 backdrop-blur-md w-full h-full rounded-[28px] p-6 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                <div className="flex-1 space-y-4">
                  ...
                  <div>
                    <h3 className="text-3xl md:text-4xl font-black text-white mb-2 leading-tight">Os Mist├®rios do Sistema Solar</h3>
                    <p className="text-white/80 font-medium">Trilha de Ci├¬ncias ÔÇó Fase 3 de 5</p>
                  </div>
                ...
                return (
                  <div key={course.id} className={`bg-white dark:bg-neutral-900 rounded-[28px] p-6 border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm flex flex-col gap-5 hover:shadow-xl hover:shadow-${course.color}-500/10 hover:-translate-y-1 transition-all group`}>
                    ...
                    <div className="space-y-1.5 mt-auto">
                      ...
                      <p className={`text-[10px] font-bold text-${course.color}-600 dark:text-${course.color}-400 text-right`}>{progress}% Conclu├¡do</p>
                    </div>
        ...
        {/* View: Player de Aula (V├¡deo / Texto) */}
                  ...
                  (() => {
                      ...
                      return (
                        <div className="w-full max-w-5xl aspect-video bg-black rounded-3xl overflow-hidden border border-white/10 shadow-2xl relative flex items-center justify-center group text-center px-4">
                          ...
                          <div className="z-20 flex flex-col items-center">
                            ...
                            <h3 className="text-white font-bold text-xl">Nenhum v├¡deo dispon├¡vel</h3>
                            <p className="text-white/60 text-sm mt-2 max-w-md">O professor ainda n├úo configurou o link para o v├¡deo desta aula.</p>
                          </div>
                        </div>
                      );
                    }
                    ...
                    return (
                      <div className="w-full max-w-5xl aspect-video bg-black rounded-3xl overflow-hidden border border-white/10 shadow-2xl relative">
                        ...
                        >
                          Seu navegador n├úo suporta a tag de v├¡deo.
                        </video>
                      </div>
                    );
                  })()
                  ...
                  <div className="w-full max-w-3xl bg-neutral-900 border border-white/10 rounded-3xl p-10 md:p-16 shadow-2xl">
                    ...
                    <div className="prose prose-invert prose-emerald max-w-none">
                      <p className="text-lg leading-relaxed text-neutral-300">
                        {activeLesson.contentBody || 'O conte├║do textual da aula ser├í exibido aqui. Pode conter par├ígrafos ricos, imagens, destaques e f├│rmulas.'}
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center p-6">
              {!quizState.isFinished ? (() => {
                if (!activeLesson.questions || activeLesson.questions.length === 0) {
                  return (
                    <div className="text-center animate-in zoom-in-95 duration-500">
                      ...
                      <p className="text-neutral-500 mb-8 max-w-sm mx-auto">Parece que o professor ainda n├úo adicionou as perguntas para este desafio.</p>
                ...
                <div className="text-center animate-in zoom-in-95 duration-500">
                  ...
                  <h2 className="text-4xl font-black text-neutral-900 dark:text-white mb-4">Desafio Conclu├¡do!</h2>
                  <p className="text-xl text-neutral-600 dark:text-neutral-400 mb-8">
                    Voc├¬ acertou {quizState.score} de {activeLesson.questions?.length} perguntas.
                  </p>
                  <button 
                    onClick={finishLesson}
                ...
                <div>
                  {quizState.isCorrect === true && (
                    <div className="flex items-center gap-3 text-emerald-600 dark:text-emerald-400">
                      ...
                      <div>
                        <h4 className="font-black text-xl leading-none">Incr├¡vel!</h4>
          ...
          <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto w-full pb-24 md:pb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col gap-2 mb-6">
              <h2 className="text-3xl font-black text-neutral-900 dark:text-white flex items-center gap-3">
                ...
                Central de Miss├Áes e Avalia├º├Áes
              </h2>
              <p className="text-neutral-500 dark:text-neutral-400">Complete testes para ganhar muita experi├¬ncia e moedas!</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-neutral-900 rounded-[28px] p-6 border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm flex flex-col gap-5 hover:shadow-xl hover:shadow-orange-500/10 hover:-translate-y-1 transition-all group">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <h4 className="font-black text-xl text-neutral-900 dark:text-white leading-tight">Diagn├│stico de Leitura e Interpreta├º├úo</h4>
                  </div>
                </div>
                ...
                >
                  <Play size={20} fill="currentColor" /> Iniciar Miss├úo
                </button>
              </div>
              ...
              <div className="bg-white dark:bg-neutral-900 rounded-[28px] p-6 border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm flex flex-col gap-5 opacity-60">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span className="bg-emerald-100 text-emerald-700 text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-md">Conclu├¡da</span>
                    </div>
                    <h4 className="font-black text-xl text-neutral-900 dark:text-white leading-tight">Matem├ítica: Adi├º├úo e Subtra├º├úo</h4>
                  </div>
                </div>
                <div className="bg-neutral-50 dark:bg-neutral-800/50 rounded-xl p-4 mt-auto">
                  <p className="text-sm font-medium text-neutral-600 dark:text-neutral-400">Nota: 10/10 ÔÇó Conclu├¡do h├í 2 dias</p>
                </div>
        ...
        {activeView === 'taking-assessment' && (
          <div className="fixed inset-0 z-[200] bg-white dark:bg-neutral-950 flex flex-col animate-in fade-in duration-300">
                ...
                {assessmentStep === 0 ? (
                  <>
                    ...
                    <div className="bg-orange-50 dark:bg-orange-500/10 p-6 rounded-2xl border border-orange-200 dark:border-orange-500/20 text-neutral-800 dark:text-neutral-200 font-medium text-lg leading-relaxed shadow-inner">
                      "O Sol ├® uma estrela que fica no centro do nosso sistema solar. Ele nos d├í luz e calor durante o dia. Sem o Sol, a Terra seria muito escura e fria para os animais e as plantas viverem."
                    </div>
                    <div className="space-y-3">
                      {['Sobre a Lua', 'Sobre o Sol e sua import├óncia', 'Sobre o frio e a escurid├úo', 'Sobre os planetas gigantes'].map((opcao, index) => (
                        <button 
                          key={index}
            ...
            <footer className="p-4 md:p-6 border-t border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 flex justify-between items-center">
              ...
              >
                {assessmentStep === 0 ? 'Pr├│xima Quest├úo' : 'Finalizar Miss├úo'} <ArrowRight size={20} />
              </button>
            </footer>
          </div>
        )}
          ...
          <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto w-full pb-24 md:pb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col gap-2 mb-6">
              <h2 className="text-3xl font-black text-neutral-900 dark:text-white flex items-center gap-3">
                ...
                Mural de Conquistas e Her├│is
              </h2>
              <p className="text-neutral-500 dark:text-neutral-400">Exiba suas medalhas e veja quem s├úo os l├¡deres da semana!</p>
            </div>
              ...
              <div className="lg:col-span-2 bg-white dark:bg-neutral-900 rounded-[32px] p-6 md:p-8 border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm flex flex-col gap-6">
                <div className="flex justify-between items-center border-b border-neutral-100 dark:border-neutral-800 pb-4">
                  <h3 className="text-2xl font-black text-neutral-900 dark:text-white flex items-center gap-2">
                    <Trophy size={24} className="text-amber-500" /> Suas Ins├¡gnias
                  </h3>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 pt-4">
                  ...
                  <div className="flex flex-col items-center text-center gap-3 group relative cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-neutral-500">Nota 10 em Matem├ítica</p>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="bg-white/20 rounded-2xl p-3 flex items-center gap-4 relative overflow-hidden ring-2 ring-yellow-400">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[10px] font-bold text-sky-100">N├¡vel 9</p>
                      </div>
                    ...
                    <div className="bg-white/10 rounded-2xl p-3 flex items-center gap-4 relative overflow-hidden">
                      ...
                      <div className="flex-1">
                        <p className="font-bold text-sm truncate text-white/90">Jo├úo Pedro</p>
                        <p className="text-[10px] font-bold text-sky-100">N├¡vel 8</p>
                      </div>
                    ...
                    <div className="bg-amber-400 text-neutral-900 rounded-2xl p-3 flex items-center gap-4 relative overflow-hidden shadow-lg shadow-amber-500/50 transform scale-105 z-10 my-6">
                      ...
                      <div className="flex-1">
                        <p className="font-black text-sm truncate">Voc├¬ ({studentData.name})</p>
                        <p className="text-[10px] font-bold text-amber-900">Subindo r├ípido! ­ƒÜÇ</p>
                      </div>
                    ...
                    <div className="bg-white/5 rounded-2xl p-3 flex items-center gap-4 relative overflow-hidden">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[10px] font-bold text-sky-200/50">N├¡vel 7</p>
                      </div>
          ...
          <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto w-full pb-24 md:pb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col gap-2 mb-8">
              <h2 className="text-3xl font-black text-neutral-900 dark:text-white flex items-center gap-3">
                ...
                Meu Perfil e Op├º├Áes
              </h2>
              <p className="text-neutral-500 dark:text-neutral-400">Personalize sua experi├¬ncia no Gest├úo 360 Educa├º├úo e deixe tudo com a sua cara!</p>
            </div>
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="w-full space-y-4 mt-2">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-neutral-500 uppercase tracking-wider pl-2">Seu Nome M├ígico</label>
                ...
                <div className="bg-white dark:bg-neutral-900 rounded-[32px] p-6 md:p-8 border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm flex flex-col gap-6">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-500 px-3 py-1 rounded-full flex items-center gap-1 font-bold text-sm">
                      <div className="w-4 h-4 bg-yellow-400 rounded-full flex items-center justify-center text-[10px] text-yellow-900">­ƒ¬Ö</div>
                      {studentData.coins}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-neutral-50 dark:bg-neutral-800/50 hover:shadow-md transition-shadow">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="font-bold text-neutral-900 dark:text-white text-sm">Avatar Rob├┤</h4>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-neutral-50 dark:bg-neutral-800/50 hover:shadow-md transition-shadow">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="font-bold text-neutral-900 dark:text-white text-sm">Tema Gal├íxia</h4>
                ...
                <div className="bg-white dark:bg-neutral-900 rounded-[32px] p-6 md:p-8 border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm flex flex-col gap-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 rounded-2xl bg-neutral-50 dark:bg-neutral-800/50 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors cursor-pointer">
                      <div>
                        <h4 className="font-bold text-neutral-900 dark:text-white text-sm">Novos Desafios Di├írios</h4>
        ...
        {/* Avalia├º├Áes (Desafios M├ígicos) UI */}
        {activeView === 'assessments' && (
          <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto w-full pb-24 md:pb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="flex-1 rounded-[32px] bg-gradient-to-br from-amber-400 via-orange-500 to-rose-500 p-8 md:p-10 text-white shadow-xl shadow-orange-500/20 relative overflow-hidden flex flex-col justify-center min-h-[200px]">
                ...
                <div className="relative z-10">
                  <h2 className="text-3xl md:text-4xl font-black mb-3 leading-tight flex items-center gap-3">
                    Desafios M├ígicos <Sparkles className="text-yellow-200" size={32} />
                  </h2>
                  <p className="text-white/90 max-w-xl text-sm md:text-base leading-relaxed">Mostre todo o seu poder e conhecimento! Cumpra as miss├Áes deixadas pelos seus professores para ganhar recompensas incr├¡veis e evoluir seu n├¡vel.</p>
                </div>
              </div>
              ...
              <div className="w-full lg:w-80 bg-white dark:bg-neutral-900 rounded-[32px] p-6 border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-neutral-400 dark:text-neutral-500 leading-tight">Voc├¬ acertou quase todas as perguntas nas ├║ltimas 3 miss├Áes. Continue assim!</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white dark:bg-neutral-900 rounded-[28px] border-2 border-rose-100 dark:border-rose-900/30 p-6 shadow-xl shadow-rose-500/5 relative overflow-hidden group hover:-translate-y-1 transition-transform">
                    ...
                    <div className="flex flex-col sm:flex-row gap-5">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="bg-rose-100 text-rose-600 dark:bg-rose-500/20 dark:text-rose-400 text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-full">Matem├ítica</span>
                          <span className="flex items-center gap-1 text-[10px] font-bold text-neutral-500"><Timer size={12}/> 40 min</span>
                        </div>
                        <h4 className="font-black text-lg text-neutral-900 dark:text-white mb-2 leading-tight">O Mist├®rio das Fra├º├Áes Perdidas</h4>
                        ...
                        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/30 rounded-xl p-3 mb-4 flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-[10px] font-bold text-neutral-500 uppercase">Recompensa da Miss├úo</p>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <button 
                            onClick={() => handleStartLesson({
                              id: 'missao-1',
                              title: 'O Mist├®rio das Fra├º├Áes Perdidas',
                              type: 'quiz',
                              duration: '40 min',
                              xp: 200,
                              coins: 100,
                              questions: [
                                { id: 'q1', question: 'Quanto ├® 1/2 + 1/4?', options: ['3/4', '1/6', '2/4', '1/8'], correctAnswer: 0 },
                                { id: 'q2', question: 'Qual fra├º├úo ├® equivalente a 0.5?', options: ['1/4', '1/2', '3/4', '1/3'], correctAnswer: 1 }
                              ]
                            })}
                  ...
                  <div className="bg-white dark:bg-neutral-900 rounded-[28px] border-2 border-neutral-100 dark:border-neutral-800/50 p-6 shadow-sm relative overflow-hidden group hover:-translate-y-1 transition-transform">
                    <div className="flex flex-col sm:flex-row gap-5">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="bg-emerald-100 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-400 text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-full">Hist├│ria</span>
                        ...
                        <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/30 rounded-xl p-3 mb-4 flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-[10px] font-bold text-neutral-500 uppercase">Recompensa da Miss├úo</p>
                            <p className="text-xs font-black text-emerald-600 dark:text-emerald-400">Ins├¡gnia do Fara├│ + 150 XP</p>
                          </div>
                        </div>
                          ...
                          <button 
                            onClick={() => handleStartLesson({
                              ...
                              questions: [
                                ...
                                { id: 'q2', question: 'Quais constru├º├Áes famosas serviam como t├║mulos para os fara├│s?', options: ['Coliseu', 'Pir├ómides', 'Acr├│pole', 'Templos Hindus'], correctAnswer: 1 }
                              ]
                            })}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-neutral-900 rounded-[32px] border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm p-2">
                  ...
                  <div className="flex items-center gap-4 p-4 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 rounded-[24px] transition-colors cursor-pointer group">
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-sm text-neutral-900 dark:text-white leading-tight">Biologia: O Reino M├ígico das Plantas</h4>
                      <p className="text-[11px] text-neutral-500 mt-0.5">Conclu├¡da h├í 3 dias</p>
                    </div>
                    <div className="text-right">
                      <div className="flex text-amber-400 mb-1">
                        <Star size={14} fill="currentColor" /><Star size={14} fill="currentColor" /><Star size={14} fill="currentColor" />
                      </div>
                      <span className="text-[10px] font-black text-sky-600 bg-sky-50 dark:bg-sky-500/10 px-2 py-1 rounded-md">Nota M├íxima!</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 rounded-[24px] transition-colors cursor-pointer group">
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-sm text-neutral-900 dark:text-white leading-tight">Portugu├¬s: Ca├ºadores de Rimas</h4>
                      <p className="text-[11px] text-neutral-500 mt-0.5">Conclu├¡da h├í 1 semana</p>
                    </div>
                    <div className="text-right">
                  ...
                  <div className="flex items-center gap-4 p-4 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 rounded-[24px] transition-colors cursor-pointer group">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[11px] text-neutral-500 mt-0.5">Conclu├¡da h├í 2 semanas</p>
                    </div>
                    <div className="text-right">
                      <div className="flex text-amber-400 mb-1 justify-end">
                        <Star size={14} fill="currentColor" /><Star size={14} fill="currentColor" /><Star size={14} fill="currentColor" />
                      </div>
                      <span className="text-[10px] font-black text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 px-2 py-1 rounded-md">Nota M├íxima!</span>
                    </div>
                  </div>
          ...
          <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto w-full pb-24 md:pb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-8 justify-between">
                <div>
                  <span className="inline-flex items-center gap-2 bg-neutral-900/20 backdrop-blur-sm text-neutral-900 text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full mb-4">
                    <Crown size={12} /> Sala dos Campe├Áes
                  </span>
                  <h2 className="text-3xl md:text-4xl font-black mb-2 leading-tight">Suas Conquistas ├ëpicas!</h2>
                  <p className="text-neutral-800 font-medium max-w-md">Cada miss├úo cumprida, cada desafio vencido te aproxima de novas e incr├¡veis recompensas. Continue sua jornada!</p>
                </div>
                {/* XP Counter */}
                <div className="bg-white/30 backdrop-blur-md rounded-[24px] p-6 border border-white/40 shrink-0 text-center min-w-[160px]">
                  ...
                  <p className="text-[10px] font-bold text-neutral-700 mt-1">N├¡vel 7 ÔåÆ 8 (74%)</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-[28px] p-6 border border-neutral-200/50 dark:border-neutral-800/50 shadow-sm flex flex-col sm:flex-row items-center gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-neutral-500">Sequ├¬ncia de Estudos ­ƒöÑ</p>
                </div>
              </div>
              <div className="flex-1 w-full">
                <div className="flex justify-between text-xs font-bold text-neutral-500 mb-2">
                  <span>Seg</span><span>Ter</span><span>Qua</span><span>Qui</span><span>Sex</span><span>S├íb</span><span>Dom</span>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                {[
                  { emoji: 'Ô¡É', name: 'Super Estrela', desc: 'Nota m├íxima em 5 miss├Áes', color: 'amber', xp: '+200 XP', date: 'Jun 10' },
                  { emoji: 'ÔÜí', name: 'Rel├ómpago', desc: 'Completou miss├úo com 15 min de sobra', color: 'yellow', xp: '+150 XP', date: 'Jun 8' },
                  { emoji: '­ƒöÑ', name: 'Em Chamas!', desc: '7 dias de sequ├¬ncia de estudos', color: 'orange', xp: '+300 XP', date: 'Jun 5' },
                  { emoji: '­ƒºÖ', name: 'Mago Matem├ítico', desc: 'Acertou 100% na trilha de N├║meros', color: 'indigo', xp: '+500 XP', date: 'Mai 28' },
                  { emoji: '­ƒôÜ', name: 'Devorador de Livros', desc: 'Leu 10 materiais de apoio', color: 'sky', xp: '+250 XP', date: 'Mai 20' },
                  { emoji: '­ƒÄ»', name: 'Mira Certeira', desc: 'Acertou 5 avalia├º├Áes seguidas', color: 'rose', xp: '+400 XP', date: 'Mai 15' },
                ].map((badge, i) => (
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                {[
                  { emoji: '­ƒÜÇ', name: 'Explorador', desc: 'Complete a trilha de Ci├¬ncias', progress: 65, needed: 'Fase 3 de 5' },
                  { emoji: '­ƒææ', name: 'Rei das Rimas', desc: 'Nota m├íxima em Portugu├¬s', progress: 80, needed: '1 miss├úo' },
                  { emoji: '­ƒªü', name: 'Cora├º├úo Bravo', desc: '20 dias de sequ├¬ncia seguidos', progress: 60, needed: '8 dias restantes' },
                  { emoji: '­ƒîƒ', name: 'Lenda da Sala', desc: 'Top 1 do ranking semanal', progress: 40, needed: 'Faltam 3 posi├º├Áes' },
                ].map((badge, i) => (
        ...
        {activeView === 'settings' && (
          <div className="p-4 md:p-8 max-w-7xl mx-auto w-full flex-1 flex flex-col items-center justify-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-neutral-500 dark:text-neutral-400 max-w-md">Em breve voc├¬ poder├í editar seus dados pessoais, alterar o avatar e ajustar suas prefer├¬ncias de notifica├º├úo aqui.</p>
          </div>
        )}
        ...
        {activeView === 'support' && (
          <div className="p-4 md:p-8 max-w-7xl mx-auto w-full flex-1 flex flex-col items-center justify-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-neutral-500 dark:text-neutral-400 max-w-md">Precisando de uma m├úozinha? Nossos monitores e suporte t├®cnico est├úo ├á disposi├º├úo.</p>
          </div>
        )}
      </main>
          ...
          {!selectedChatTeacher ? (
            ...
            <>
              <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-5 text-white shrink-0">
                ...
                <p className="text-emerald-100 text-sm font-medium">Com quem voc├¬ quer falar?</p>
              </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex justify-between items-center">
                          <p className={`text-sm truncate ${unread > 0 ? 'font-bold text-neutral-900 dark:text-white' : 'text-neutral-500'}`}>
                            {lastMsg ? (lastMsg.sender === 'student' ? `Voc├¬: ${lastMsg.text}` : lastMsg.text) : 'Nenhuma mensagem'}
                          </p>
                          {unread > 0 && (
