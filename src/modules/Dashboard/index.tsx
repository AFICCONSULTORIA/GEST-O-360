...
const getComplianceDataForYear = (year: string) => {
  ...
  return [
    ...
    { name: 'Jun', value: Math.min(100, base[4] + 2) }
  ];
};

export const DashboardModule = ({ controls, onViewAll, selectedYear, darkMode }: { controls: CheckItem[], onViewAll: () => void, selectedYear: string, darkMode: boolean }) => {
