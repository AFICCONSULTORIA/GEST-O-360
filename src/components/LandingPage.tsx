    ...
    <div className="min-h-[100dvh] bg-[#F4F4F2] dark:bg-neutral-950 flex flex-col overflow-hidden relative transition-colors duration-300">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <motion.div
          ...
          className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 w-full max-w-7xl px-4"
        >
          ...
          <a
            href="/cmei"
            className="group relative bg-white/80 dark:bg-neutral-900/80 backdrop-blur-md border border-neutral-200/50 dark:border-neutral-800/80 rounded-[32px] p-8 text-left hover:shadow-2xl hover:shadow-pink-500/10 hover:-translate-y-2 transition-all duration-300 cursor-pointer overflow-hidden flex flex-col justify-between"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-pink-50/50 to-transparent dark:from-pink-950/20 dark:to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <div className="relative space-y-5">
              <div className="w-14 h-14 bg-pink-50 dark:bg-pink-500/10 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:bg-pink-500 group-hover:text-white dark:group-hover:text-neutral-950 transition-all duration-300 text-pink-600 dark:text-pink-400 shadow-sm">
                <Baby size={24} />
              </div>
              <div>
                <h2 className="text-xl font-bold text-neutral-900 dark:text-white tracking-tight group-hover:text-pink-600 dark:group-hover:text-pink-400 transition-colors">Vagas no CMEI</h2>
                <p className="text-xs sm:text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed mt-2 font-medium">
                  Acompanhe vagas, critérios de seleção e documentação da Fila Única.
                </p>
              </div>
            </div>
            <div className="relative mt-8 flex items-center gap-2 text-pink-600 dark:text-pink-400 text-xs font-black uppercase tracking-widest border-t border-neutral-100 dark:border-neutral-800/80 pt-4 w-full">
