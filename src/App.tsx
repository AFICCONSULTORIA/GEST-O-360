    ...
    <div className="min-h-[100dvh] bg-[#F4F4F2] dark:bg-neutral-950 flex flex-col overflow-hidden relative transition-colors duration-300">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <motion.div
          ...
          className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-6xl px-4"
        >
...
const Login = ({ onLogin, onDemoLogin, darkMode, currentInstitution, isSaaSAdmin = false }: { onLogin: () => void, onDemoLogin?: () => void, darkMode: boolean, currentInstitution?: Institution | null, isSaaSAdmin?: boolean }) => {
